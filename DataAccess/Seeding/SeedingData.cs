		...
		public static void Seeding(ModelBuilder modelBuilder)
		{
            ...
            modelBuilder.Entity<Story>().HasData(
                ...
                new Story { StoryId = 3, Title = "I Returned as an FFF-Class Witch", AuthorName = "Dian Hui Kuang", Content = "Once it starts up, the dungeon goes through a process called “Reset the Next User”. Why doesn’t this reset process apply to me ?!I am the only one left from that endless reset of this dungeon. With simple skills and an overwhelming weapon, Jung-down game starts inside the dungeon",
					View = 0, CreateAt = DateTime.Now, ImageStory = "", IsActive = true },
                new Story { StoryId = 4, Title = "Solo Leveling", AuthorName = "Jang Sung-Lak", Content = "",
					View = 0, CreateAt = DateTime.Now, ImageStory = "", IsActive = true },
                new Story { StoryId = 5, Title = "Chainsaw Man", AuthorName = "Fujimono Tatsuki", Content = "There's a new hero in town and he's got a bad attitude and a chainsaw dog demon! A dangerous combo.",
					View = 0, CreateAt = DateTime.Now, ImageStory = "", IsActive = true },
                new Story { StoryId = 6, Title = "Spy x Family", AuthorName = "Endou Tatsuya", Content = "The master spy codenamed has spent his days on undercover missions, all for the dream of a better world. But one day, he receives a particularly difficult new order from command. For his mission, he must form a temporary family and start a new life?! A Spy/Action/Comedy about a one-of-a-kind family!",
					View = 0, CreateAt = DateTime.Now, ImageStory = "", IsActive = true },
                new Story { StoryId = 7, Title = "Kingdom", AuthorName = "Hara Yasushia", Content = "Millions of years have passed since the times of legends, when the worlds of man and gods were still the same. In these times it was the desires of man that moved the world. It is the era of the 500 year war: The warring states period. Kingdom is the story of a young boy named Shin who grew into a great general and all the trials and bloodshed that lead him there.",
					View = 0, CreateAt = DateTime.Now, ImageStory = "", IsActive = true },
                new Story { StoryId = 8, Title = "Bleach", AuthorName = "Kisimoto Masashi", Content = "Ichigo Kurosaki has always been able to see ghosts, but this ability doesn't change his life nearly as much as his close encounter with Rukia Kuchiki, a soul reaper and member of the mysterious Soul Society. While fighting a hollow, an evil spirit that preys on humans who display spiritual energy, Rukia attempts to lend Ichigo some of her powers so that he can save his family; but much to her surprise, Ichigo absorbs every last drop of her energy.",
                    View = 0, CreateAt = DateTime.Now, ImageStory = "", IsActive = true },
                new Story { StoryId = 9, Title = "Dragon Ball Super", AuthorName = "Toriyama Akira", Content = "Son Goku's adventure starts with Bulma crashing into to him while she is searching for the seven magical Dragon Balls, which can grant any wish. Together, they meet many people and many foes in their adventure chasing after the Dragon Balls.",
					View = 0, CreateAt = DateTime.Now, ImageStory = "", IsActive = true },
                new Story { StoryId = 10, Title = "Gintama", AuthorName = "Hieaki Sorachi", Content = "The samurai didn't stand a chance. First, the aliens invaded Japan. Next, they took all the jobs. And then they confiscated everyone's swords. So what does a hotheaded former samurai like Sakata \"Gin\" Gintoki do to make ends meet? Take any odd job that comes his way, even if it means losing his dignity.",
					View = 0, CreateAt = DateTime.Now, ImageStory = "", IsActive = true },
                new Story { StoryId = 11, Title = "Tower Of God", AuthorName = "Slave In Utero", Content = "What do you desire? Fortune? Glory? Power? Revenge? Or something that surpasses all others? What ever you desire, 'that is here'. Tower of God.",
					View = 0, CreateAt = DateTime.Now, ImageStory = "", IsActive = true },
                new Story { StoryId = 12, Title = "The Gamer", AuthorName = "Sang Ah", Content = "What would happen if your world suddenly turned into a game?If you could level up and raise your stats?An adventure of a life-turned-game",
					View = 0, CreateAt = DateTime.Now, ImageStory = "", IsActive = true },
                new Story { StoryId = 13, Title = "Relife Player", AuthorName = "Siyun", Content = "Noh Eunha. After losing his family and closing off his heart, he just wanted to kill the monsters he loathed. I regressed before my life came to an end in the deepest part of the that was impossible for mankind to raid.",
					View = 0, CreateAt = DateTime.Now, ImageStory = "", IsActive = true },
                new Story { StoryId = 14, Title = "Baek XX", AuthorName = "Park tae jun", Content = "Federal Informant Baek Yisu and a criminal gangs boss, Baek Dogyeong are twin brothers. With the same faces the two twin brothers have lived different lives until now. Yisu, whos been betrayed by the gang, throws away his identity to become his brother. This federal agent is soon to become the gangs boss!",
					View = 0, CreateAt = DateTime.Now, ImageStory = "", IsActive = true }
